...
class UsersController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $new_users->name=$request->post('name');
        $new_users->username = $request->post('username');
        $new_users->roles = json_encode($request->post('roles'));
        $new_users->address = $request->post('address');
        $new_users->phone = $request->post('phone');
        $new_users->email = $request->post('email');
        $new_users->password = \Hash::make($request->post('password'));
