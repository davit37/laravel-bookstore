...
@elseif(session('status_restore'))
<div class="row">
    <div class="col-md-12">
      <div class="alert alert-success">
        {{session('status_restore')}}
      </div>
    </div>
  </div>
@endif
    ...
    <div class="col-md-12">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                <a class="btn btn-info text-white btn-sm" role='button' href="{{route('categories.edit', ['id'=>$category->id])}}">Edit</a>
                <form 
                    class="d-inline"
